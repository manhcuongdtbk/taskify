  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        "actions/!(create-board|delete-board|delete-list|update-card-order|create-card|copy-card|update-list-order|update-card|delete-card|copy-list|create-list|update-list|update-board)/index.ts", // untested handlers
