...
| Piece                   | Path                                                                                                                | Role                                                                                                                               |
| ----------------------- | ------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| Free-plan limit trigger | `components/form/form-popover.tsx` · `components/modals/pro-modal-trigger.tsx` · `board-list/create-board-tile.tsx` | Limit error from create-board still opens Pro; at-cap tile uses ProModalTrigger as the tile button, with Hint as a sibling control |
