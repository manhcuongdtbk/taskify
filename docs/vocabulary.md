...
| **Optimistic UI**                  | Show hoped-for result **before** the mutation finishes; roll back on error                | Not the same as applying Action `data` in `onSuccess` (confirmed local mirror). Teach: [`data.md`](./data.md)                                                                                                                                                                                                                                 |
