...
| Free-plan limits               | Cap boards on the **Free** plan; nudge toward **Pro**                                | `lib/board-limits/organization-limit.ts`, `lib/subscription.ts`, create-board action, `FormPopover` (navbar + board tile), pro modal                |
