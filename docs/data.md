...
| After success, refresh **TanStack Query** cache            | `queryClient.invalidateQueries` on the client using keys from [`lib/api/`](../lib/api/) factories                                                                                                                                                                                                                                                                                                                                                                                                                                          | Card modal → `cardQueries.detail` / `.logs`                                                                                                                         |
