...
| -------------------------- | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Confirmed local mirror** | **After** the Action returns `{ data }` (`onSuccess`)                          | Plain `setState` from Action `data`                                                                                                               | [`board-title-form.tsx`](<../app/(platform)/(dashboard)/board/[boardId]/_components/board-title-form.tsx>), [`list-header.tsx`](<../app/(platform)/(dashboard)/board/[boardId]/_components/list-header.tsx>), card modal header |
