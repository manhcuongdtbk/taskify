...
4. Provider: [`providers/query-provider.tsx`](../providers/query-provider.tsx) via [`createQueryClient`](../lib/tanstack-query/client.ts) (skip 4xx except 408/429, and Zod retries).
