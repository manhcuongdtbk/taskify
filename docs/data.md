...
4. Provider: [`providers/query-provider.tsx`](../providers/query-provider.tsx) via [`createQueryClient`](../lib/tanstack-query/client.ts) (no 4xx / Zod retries).
