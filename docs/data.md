...
| **Client factories** (keys + `queryFn`, later Query mutations)  | [`lib/api/<resource>.ts`](../lib/api/) — SoT for layout below                                                                                                                    |
...
| Choice                                              | Use it?                  | Why                                                                                                                                                                                                                                                                              |
| --------------------------------------------------- | ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`lib/api/card.ts` + `cardQueries` factory**       | **Yes**                  | Common practice for Query: one module per remote **resource**, co-locating `queryKey` + `queryFn` (and later Query mutations). Works for **any origin** (our BFF, other services we own, third parties) — not “Next server only.”                                                |
