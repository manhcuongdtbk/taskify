 ...
 *   docs/billing.md → “Complete the current picture first” (do that before growth doors).
...
export async function POST(req: Request) {
  ...
  //
  // TODO (P0 — docs/billing.md “Complete the current picture first”): First-payment
